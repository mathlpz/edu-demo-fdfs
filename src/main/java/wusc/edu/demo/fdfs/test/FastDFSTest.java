...
public class FastDFSTest {
	...
	public static void upload() throws Exception {
		String filePath = "D:/GitHub/edu-demo-fdfs/TestFile/DubboVideo.jpg";
		File file = new File(filePath);
		String fileId = FastDFSClient.uploadFile(file, filePath);
		System.out.println("Upload local file " + filePath + " ok, fileid=" + fileId);
		// fileId:	group1/M00/00/00/wKjcgFpD5NuAMRrQAAP3btxj__E957.jpg
		// url:	http://192.168.220.128:8888/group1/M00/00/00/wKjcgFpD5NuAMRrQAAP3btxj__E957.jpg
	}
